...
{{--        <li><a href="{{route('libros.index')}}"><i class="material-icons ">book</i><span data-i18n="Modern Menu">Prestamo de Libros</span></a></li>--}}
    @endif
    <li><a href="https://administracionyfinanzasplem.gob.mx/espaciogenero/Forros_bueno.pdf" target="_blank" ><i class="material-icons ">assignment_ind</i><span data-i18n="Modern Menu">Manual</span></a></li>
